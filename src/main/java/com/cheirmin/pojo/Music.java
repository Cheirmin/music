...
public class Music {
    ...
    public Music(String id, String musicName, String singerName, String musicUrl, String musicPhotoUrl, String musicTime, String album) {
        this.id = id;
    ...
    public Music(String id, String musicName, String singerName, String musicUrl, String musicPhotoUrl, String musicWords, String musicTime,String album) {
        this.id = id;
        this.musicName = musicName;
        this.singerName = singerName;
        this.musicUrl = musicUrl;
